  ...
  >
    <article className="media">
      ...
      <div className="media-content">
        <div className="content">
          <p>
          <strong>Raghunath - Window2
</strong> <small>Raghunath.s@outlook.com</small> <small> MERN Stack Developer</small>
            <br/>
            Javascript | ReactJS | Redux | NodeJS | Express | MongoDB | Jest
  ...
  >
    <article className="media">
      ...
      <div className="media-content">
        <div className="content">
          <p>
          <strong>ShivaPrasad Dabbara - Window3
</strong> <small>ShivaPrasad.d@outlook.com</small> <small> MERN Stack Developer</small>
            <br/>
            Javascript | ReactJS | Redux | NodeJS | Express | MongoDB | Jest
